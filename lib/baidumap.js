 ...
 */
window.BMAP_AUTHENTIC_KEY = "SsLWt8zrrLx0yjkQhsScktRSujw0TFQE";
var a = function () {
  function aa(a) {
    throw a;
  }
    ...
    (function (a, b, c) {
      ...
      if (!C || !C.Ho) {
        ...
        c.alog("exception.on", "catch", function (a) {
          c.alog("exception.send", "exception", {TM: a.TM, vY: a.path, xM: a.xM, method: a.method, IW: "catch"})
        })
      }
    })(a, b, c);
    (function (a, b, c) {
      ...
      if (k && k.an && i() < k.an) {
        ...
        c.alog("monkey.create", {page: g, pid: "241", p: "18", oy: "http://nsclick.baidu.com/u.gif", O3: {M3: 1}});
